...
const PATHS: Record<IconName, JSX.Element> = {
  ...
  // Folded map — reads "Atlas" instantly and can't be confused with aperture.
  globe: <><path d="M9 4.5 3.6 6.3a1 1 0 0 0-.6.9v11.4a1 1 0 0 0 1.4.9L9 17.7l6 1.8 5.4-1.8a1 1 0 0 0 .6-.9V5.4a1 1 0 0 0-1.4-.9L15 6.3l-6-1.8Z" /><path d="M9 4.5v13.2" /><path d="M15 6.3v13.2" /></>,
